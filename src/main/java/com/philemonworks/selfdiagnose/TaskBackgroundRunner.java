...
/**
 * TaskBackgroundRunner will run a task on a background thread and expects it to complete within a specified amout of seconds.
...
public class TaskBackgroundRunner {
    ...
    /**
     * Run the task but do not wait for it to complete after the specified number of seconds.
     */    
